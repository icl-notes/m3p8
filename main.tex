...
This means, for instance, that we can show that a monic polynomial in $ \Z\sbr{X} $ is irreducible if we can find even one prime $ p $ for which it is irreducible mod $ p $.
